...
import fmagic.basic.license.ResourceContainerLicense;
import fmagic.basic.media.ResourceContainerMedia;
import fmagic.basic.resource.ResourceContainer.OriginEnum;
import fmagic.basic.resource.ResourceContainer.TypeEnum;
import fmagic.basic.resource.ResourceContainer.UsageEnum;
...
public class ResourceManager implements ManagerInterface
{
	...
	{
		return FileLocationFunctions.compileFilePath(FileLocationFunctions.getRootPath(), FileLocationFunctions.getResourceSubPath());
	}
	...
	public boolean loadResourceFile(Context context, String applicationIdentifier, int applicationVersion, String otherFileName)
	{
		...
		{
			fileName = FileLocationFunctions.compileFilePath(this.getResourceFilePath(context), getResourceFileName(context, applicationIdentifier));
		}
